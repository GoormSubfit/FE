  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.options}>
        <button
          className={`${styles.optionBtn} ${selected === "신선식품 주문계획 있음" ? styles.selected : ""}`}
          onClick={() => handleClick("신선식품 주문계획 있음")}
        >
          네
        </button>
        <button
          className={`${styles.optionBtn} ${selected === "신선식품 주문계획 없음" ? styles.selected : ""}`}
          onClick={() => handleClick("신선식품 주문계획 없음")}
        >
          아니요
        </button>
      </div>
